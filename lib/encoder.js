(function() {
  ...
  module.exports = Encoder = (function(superClass) {
    ...
    Encoder.prototype._pushObject = function(obj) {
      var f, i, j, k, keys, l, len1, len2, numericKeys, opts, ref1, results, typ;
      if (!obj) {
      ...
      opts = this.opts ? this.opts : {};
      numericKeys = opts.numericKeys ? opts.numericKeys : false;
    ...
    Encoder.encodeOpts = function() {
      var bs, enc, j, len1, o, objs, opts;
      opts = arguments[0], objs = 2 <= arguments.length ? slice.call(arguments, 1) : [];
      enc = new Encoder;
      enc.opts = opts;
      bs = new NoFilter;
      enc.pipe(bs);
